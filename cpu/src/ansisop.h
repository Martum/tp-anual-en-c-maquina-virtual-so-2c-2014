...
void ansisop_ejecucion_instruccion2(instruccion_t instruccion, int32_t param_numero);
void ansisop_ejecucion_instruccion3(instruccion_t instruccion, int32_t param_numero, char param_registro);
